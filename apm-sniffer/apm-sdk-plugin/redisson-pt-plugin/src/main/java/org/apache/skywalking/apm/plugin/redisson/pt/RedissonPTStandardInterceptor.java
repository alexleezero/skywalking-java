...
import org.apache.skywalking.apm.plugin.redisson.pt.model.ShadowRedissonClient;
 ...
 * @since 2022/1/11
 */
public class RedissonPTStandardInterceptor implements StaticMethodsAroundInterceptor {
	...
	public Object afterMethod(Class clazz, Method method, Object[] allArguments, Class<?>[] parameterTypes, Object ret) {
		if (PressureTestContext.isTest()) {
			if (CACHE_SHADOW_MODE == CacheShadowMode.SHADOW_KEY) {
				return new ShadowRedissonClient((RedissonClient) ret);
			}
		}
		return ret;
	}
