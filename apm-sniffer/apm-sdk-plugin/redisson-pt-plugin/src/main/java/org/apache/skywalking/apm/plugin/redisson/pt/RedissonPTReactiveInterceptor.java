...
import org.apache.skywalking.apm.plugin.redisson.pt.model.ShadowRedissonReactiveClient;
 ...
 * @since 2022/1/11
 */
public class RedissonPTReactiveInterceptor implements StaticMethodsAroundInterceptor {
	...
	public Object afterMethod(Class clazz, Method method, Object[] allArguments, Class<?>[] parameterTypes, Object ret) {
		if (PressureTestContext.isTest()) {
			if (CACHE_SHADOW_MODE == CacheShadowMode.SHADOW_KEY) {
				return new ShadowRedissonReactiveClient((RedissonReactiveClient) ret);
			}
		}
		return ret;
	}
