    ...
    public Object afterMethod(EnhancedInstance objInst, Method method, Object[] allArguments, Class<?>[] argumentsTypes, Object ret) throws Throwable {
        if (PressureTestContext.isTest()) {
            if (method.getName().equals("sync")) {
                   return new RedisClusterPubSubCommandsDelegate((RedisClusterPubSubCommandsDelegate) ret);
            } else if (method.getName().equals("async")) {
                return new RedisClusterPubSubAsyncCommandsDelegate((RedisClusterPubSubAsyncCommandsDelegate) ret);
            } else if (method.getName().equals("reactive")) {
                return new RedisClusterPubSubReactiveCommandsDelegate((RedisClusterPubSubReactiveCommandsDelegate) ret);
            }
        }
        return ret;
    }
