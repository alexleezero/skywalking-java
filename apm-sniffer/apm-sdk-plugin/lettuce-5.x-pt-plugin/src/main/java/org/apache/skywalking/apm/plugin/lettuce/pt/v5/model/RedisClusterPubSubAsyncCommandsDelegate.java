 ...
 * @since 2022/1/4
 */
public class RedisClusterPubSubAsyncCommandsDelegate<K, V> implements RedisClusterPubSubAsyncCommands<K, V> {
    private final RedisClusterPubSubAsyncCommands<K, V> origin;

    public RedisClusterPubSubAsyncCommandsDelegate(RedisClusterPubSubAsyncCommands<K, V> origin) {
        this.origin = origin;
    }
    ...
    @Override
    public PubSubAsyncNodeSelection<K, V> masters() {
        return origin.masters();
    }

    @Override
    public PubSubAsyncNodeSelection<K, V> slaves() {
        return origin.slaves();
    }

    @Override
    @Deprecated
    public PubSubAsyncNodeSelection<K, V> slaves(Predicate<RedisClusterNode> predicate) {
        return origin.slaves(predicate);
    }

    @Override
    @Deprecated
    public PubSubAsyncNodeSelection<K, V> replicas() {
        return origin.replicas();
    }

    @Override
    public PubSubAsyncNodeSelection<K, V> replicas(Predicate<RedisClusterNode> predicate) {
        return origin.replicas(predicate);
    }

    @Override
    public PubSubAsyncNodeSelection<K, V> all() {
        return origin.all();
    }
    ...
    public RedisFuture<Void> psubscribe(K... patterns) {
        return origin.psubscribe(RedisToolManager.LETTUCE_TOOL.convertShadowKeys(patterns));
    }

    @Override
    public RedisFuture<Void> punsubscribe(K... patterns) {
        return origin.punsubscribe(RedisToolManager.LETTUCE_TOOL.convertShadowKeys(patterns));
    }

    @Override
    public RedisFuture<Void> subscribe(K... channels) {
        return origin.subscribe(RedisToolManager.LETTUCE_TOOL.convertShadowKeys(channels));
    }

    @Override
    public RedisFuture<Void> unsubscribe(K... channels) {
        return origin.unsubscribe(RedisToolManager.LETTUCE_TOOL.convertShadowKeys(channels));
    }
    ...
    public RedisFuture<Long> pfcount(K... keys) {
        return origin.pfcount(RedisToolManager.LETTUCE_TOOL.convertShadowKey(keys));
    }

    @Override
    public RedisFuture<Long> unlink(K... keys) {
        return origin.unlink(RedisToolManager.LETTUCE_TOOL.convertShadowKey(keys));
    }
    ...
    public RedisFuture<Long> exists(K... keys) {
        return origin.exists(RedisToolManager.LETTUCE_TOOL.convertShadowKey(keys));
    }
    ...
    public RedisFuture<String> rename(K key, K newKey) {
        return origin.rename(RedisToolManager.LETTUCE_TOOL.convertShadowKey(key), RedisToolManager.LETTUCE_TOOL.convertShadowKey(newKey));
    }

    @Override
    public RedisFuture<Boolean> renamenx(K key, K newKey) {
        return origin.renamenx(RedisToolManager.LETTUCE_TOOL.convertShadowKey(key), RedisToolManager.LETTUCE_TOOL.convertShadowKey(newKey));
    }
    ...
    public RedisFuture<Long> sinterstore(K destination, K... keys) {
        return origin.sinterstore(RedisToolManager.LETTUCE_TOOL.convertShadowKey(destination), RedisToolManager.LETTUCE_TOOL.convertShadowKeys(keys));
    }
    ...
    public RedisFuture<Long> sunionstore(K destination, K... keys) {
        return origin.sunionstore(RedisToolManager.LETTUCE_TOOL.convertShadowKey(destination),
                RedisToolManager.LETTUCE_TOOL.convertShadowKeys(keys));
    }
    ...
    public RedisFuture<Long> zunionstore(K destination, ZStoreArgs storeArgs, K... keys) {
        return origin.zunionstore(RedisToolManager.LETTUCE_TOOL.convertShadowKey(destination), storeArgs,
                RedisToolManager.LETTUCE_TOOL.convertShadowKeys(keys));
    }
    ...
    public RedisFuture<Long> bitopAnd(K destination, K... keys) {
        return origin.bitopAnd(RedisToolManager.LETTUCE_TOOL.convertShadowKey(destination),
                RedisToolManager.LETTUCE_TOOL.convertShadowKeys(keys));
    }
