...
public class RedisClusterPubSubCommandsDelegate<K, V> implements RedisClusterPubSubCommands<K, V> {
    ...
    public void psubscribe(K... patterns) {
        origin.psubscribe(RedisToolManager.LETTUCE_TOOL.convertShadowKeys(patterns));
    }

    @Override
    public void punsubscribe(K... patterns) {
        origin.punsubscribe(RedisToolManager.LETTUCE_TOOL.convertShadowKeys(patterns));
    }

    @Override
    public void subscribe(K... channels) {
        origin.subscribe(RedisToolManager.LETTUCE_TOOL.convertShadowKeys(channels));
    }

    @Override
    public void unsubscribe(K... channels) {
        origin.unsubscribe(RedisToolManager.LETTUCE_TOOL.convertShadowKeys(channels));
    }
    ...
    public <T> T eval(String script, ScriptOutputType type, K... keys) {
        return origin.eval(script, type,
    ...
    public Long sunionstore(K destination, K... keys) {
        return origin.sunionstore(RedisToolManager.LETTUCE_TOOL.convertShadowKey(destination), RedisToolManager.LETTUCE_TOOL.convertShadowKey(keys));
    }
    ...
    public Long bitopOr(K destination, K... keys) {
        return origin.bitopOr(RedisToolManager.LETTUCE_TOOL.convertShadowKey(destination),
                RedisToolManager.LETTUCE_TOOL.convertShadowKeys(keys));
    }

    @Override
    public Long bitopXor(K destination, K... keys) {
        return origin.bitopXor(RedisToolManager.LETTUCE_TOOL.convertShadowKey(destination),
                RedisToolManager.LETTUCE_TOOL.convertShadowKeys(keys));
    }
