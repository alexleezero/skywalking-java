 ...
 * @since 2022/1/4
 */
public class RedisClusterPubSubReactiveCommandsDelegate<K, V> implements RedisClusterPubSubReactiveCommands<K, V> {
    private final RedisClusterPubSubReactiveCommands<K, V> origin;

    public RedisClusterPubSubReactiveCommandsDelegate(RedisClusterPubSubReactiveCommands<K, V> origin) {
        this.origin = origin;
    }
    ...
    @Override
    public PubSubReactiveNodeSelection<K, V> masters() {
        return origin.masters();
    }

    @Override
    @Deprecated
    public PubSubReactiveNodeSelection<K, V> slaves() {
        return origin.slaves();
    }

    @Override
    @Deprecated
    public PubSubReactiveNodeSelection<K, V> slaves(Predicate<RedisClusterNode> predicate) {
        return origin.slaves(predicate);
    }

    @Override
    public PubSubReactiveNodeSelection<K, V> replicas() {
        return origin.replicas();
    }

    @Override
    public PubSubReactiveNodeSelection<K, V> replicas(Predicate<RedisClusterNode> predicate) {
        return origin.replicas(predicate);
    }

    @Override
    public PubSubReactiveNodeSelection<K, V> all() {
        return origin.all();
    }
    ...
    public Mono<Long> zinterstore(K destination, ZStoreArgs storeArgs, K... keys) {
        return origin.zinterstore(RedisToolManager.LETTUCE_TOOL.convertShadowKey(destination), storeArgs,
                RedisToolManager.LETTUCE_TOOL.convertShadowKeys(keys));
    }
    ...
    public Mono<Long> zunionstore(K destination, K... keys) {
        return origin.zunionstore(RedisToolManager.LETTUCE_TOOL.convertShadowKey(destination),
                RedisToolManager.LETTUCE_TOOL.convertShadowKeys(keys));
    }
    ...
    public Mono<Long> bitopXor(K destination, K... keys) {
        return origin.bitopXor(RedisToolManager.LETTUCE_TOOL.convertShadowKey(destination), RedisToolManager.LETTUCE_TOOL.convertShadowKey(keys));
    }
