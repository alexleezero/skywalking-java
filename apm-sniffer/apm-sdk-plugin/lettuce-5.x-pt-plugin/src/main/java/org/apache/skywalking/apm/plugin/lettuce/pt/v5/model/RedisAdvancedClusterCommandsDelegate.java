 ...
 * @since 2022/1/4
 */
public class RedisAdvancedClusterCommandsDelegate<K, V> implements RedisAdvancedClusterCommands<K, V> {
    private final RedisAdvancedClusterCommands<K, V> origin;

    public RedisAdvancedClusterCommandsDelegate(RedisAdvancedClusterCommands<K, V> origin) {
        this.origin = origin;
    }
    ...
    @Override
    public NodeSelection<K, V> masters() {
        return origin.masters();
    }

    @Override
    @Deprecated
    public NodeSelection<K, V> slaves() {
        return origin.slaves();
    }

    @Override
    @Deprecated
    public NodeSelection<K, V> slaves(Predicate<RedisClusterNode> predicate) {
        return origin.slaves(predicate);
    }

    @Override
    public NodeSelection<K, V> replicas() {
        return origin.replicas();
    }

    @Override
    public NodeSelection<K, V> replicas(Predicate<RedisClusterNode> predicate) {
        return origin.replicas(predicate);
    }

    @Override
    public NodeSelection<K, V> all() {
        return origin.all();
    }
    ...
    public String mset(Map<K, V> map) {
        ...
        map.entrySet().forEach(entrySet -> {
            newMap.put(RedisToolManager.LETTUCE_TOOL.convertShadowKey(entrySet.getKey()), entrySet.getValue());
        });
    ...
    public Long sunionstore(K destination, K... keys) {
        return origin.sunionstore(RedisToolManager.LETTUCE_TOOL.convertShadowKey(destination), RedisToolManager.LETTUCE_TOOL.convertShadowKeys(keys));
    }
    ...
    public Long zinterstore(K destination, ZStoreArgs storeArgs, K... keys) {
        return origin.zinterstore(RedisToolManager.LETTUCE_TOOL.convertShadowKey(destination),
                storeArgs, RedisToolManager.LETTUCE_TOOL.convertShadowKeys(keys));
    }
    ...
    public Long zunionstore(K destination, ZStoreArgs storeArgs, K... keys) {
        return origin.zunionstore(RedisToolManager.LETTUCE_TOOL.convertShadowKey(destination), storeArgs, RedisToolManager.LETTUCE_TOOL.convertShadowKey(keys));
    }
    ...
    public Long bitopAnd(K destination, K... keys) {
        return origin.bitopAnd(RedisToolManager.LETTUCE_TOOL.convertShadowKey(destination), RedisToolManager.LETTUCE_TOOL.convertShadowKey(keys));
    }
    ...
    public Long bitopOr(K destination, K... keys) {
        return origin.bitopOr(destination, RedisToolManager.LETTUCE_TOOL.convertShadowKeys(keys));
    }

    @Override
    public Long bitopXor(K destination, K... keys) {
        return origin.bitopXor(destination, RedisToolManager.LETTUCE_TOOL.convertShadowKeys(keys));
    }
