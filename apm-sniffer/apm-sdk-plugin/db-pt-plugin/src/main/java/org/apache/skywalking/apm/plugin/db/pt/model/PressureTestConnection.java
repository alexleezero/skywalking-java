...
public class PressureTestConnection implements Connection {
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        if (shadowMode == ShadowMode.DB) {
            ...
            return new PressureTestPreparedStatement(originalConn.prepareStatement(SQLParser.convert2Shadow(sql, getDbType())));
        }
    }
    ...
    public CallableStatement prepareCall(String sql) throws SQLException {
        if (shadowMode == ShadowMode.DB) {
            ...
            return new PressureTestCallableStatement(originalConn.prepareCall(SQLParser.convert2Shadow(sql, getDbType())));
        }
    }
    ...
    public String nativeSQL(String sql) throws SQLException {
        if (shadowMode == ShadowMode.DB) {
            ...
            return originalConn.nativeSQL(SQLParser.convert2Shadow(sql, getDbType()));
        }
    }
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        if (shadowMode == ShadowMode.DB) {
            ...
            return new PressureTestPreparedStatement(
                    originalConn.prepareStatement(SQLParser.convert2Shadow(sql, getDbType()), resultSetType, resultSetConcurrency));
        }
    }
    ...
    public CallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
        if (shadowMode == ShadowMode.DB) {
            ...
            return new PressureTestCallableStatement(
                    originalConn.prepareCall(SQLParser.convert2Shadow(sql, getDbType()), resultSetType, resultSetConcurrency));
        }
    }
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        if (shadowMode == ShadowMode.DB) {
            ...
            return new PressureTestPreparedStatement(
                    originalConn.prepareStatement(SQLParser.convert2Shadow(sql, getDbType()), resultSetType, resultSetConcurrency, resultSetHoldability));
        }
    }
    ...
    public CallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        if (shadowMode == ShadowMode.DB) {
            ...
            return new PressureTestCallableStatement(
                    originalConn.prepareCall(SQLParser.convert2Shadow(sql, getDbType()), resultSetType, resultSetConcurrency, resultSetHoldability));
        }
    }
    ...
    public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        if (shadowMode == ShadowMode.DB) {
            ...
            return new PressureTestPreparedStatement(
                    originalConn.prepareStatement(SQLParser.convert2Shadow(sql, getDbType()), autoGeneratedKeys));
        }
    }
    ...
    public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
        if (shadowMode == ShadowMode.DB) {
            ...
            return new PressureTestPreparedStatement(
                    originalConn.prepareStatement(SQLParser.convert2Shadow(sql, getDbType()), columnIndexes));
        }
    }
    ...
    public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
        if (shadowMode == ShadowMode.DB) {
            ...
            return new PressureTestPreparedStatement(
                    originalConn.prepareStatement(SQLParser.convert2Shadow(sql, getDbType()), columnNames));
        }
    }
